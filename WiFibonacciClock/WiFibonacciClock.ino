...
/*TODOs:
    - load only first palette
    - save the settings every once in a while
    - WIP add a reset factory settings button in the UI
    - WIP add a save / restore UI for the settings
    - WIP broadcast settings and palettes each time a change happens 
    - broadcast palette deletion
*/
